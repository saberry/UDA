...
statement <- "Choking on your alibis. But it's just the price I pay. Destiny is calling me. Open up my eager eyes, cause I'm Mister Brightside."
...
instruments['scores'] = instruments['reviewText'].apply(
  lambda reviewText: sid.polarity_scores(reviewText))
```

You might also have an easy time using TextBlob:

```{python}
import textblob

textblob.TextBlob('Smoke weed everyday!').sentiment
```
...
neg_text = 'I dislike code, but I really love money.'
