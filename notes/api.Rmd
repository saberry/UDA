...
av_read <- RJSONIO::fromJSON(content(avRequest, as = "text"))
...
avLinkGenerator = "https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY&symbol={}&apikey={}".format(
  avSymbol, avKey)

avRequest = requests.get(avLinkGenerator)

av_json = avRequest.json()
